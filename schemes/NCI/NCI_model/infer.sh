...
python main.py --decode_embedding 2 --n_gpu 1 --mode eval --query_type gtq_doc_aug_qg --adaptor_layer_num 4 \
 --num_return_sequences $BEAM_SIZE --tree 1 \
--model_info $model_info --train_batch_size 64 --eval_batch_size 1 --test1000 0 --dropout_rate 0.1 --Rdrop 0.1 \
...
--trivia 0 --nq 1 --nci_final $NCI_FINAL
